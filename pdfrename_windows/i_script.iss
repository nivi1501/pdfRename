...
AppId={{30B7F10E-F378-4443-9C05-5854179F3BCD}
AppName={#MyAppName}
...
OutputBaseFilename=pdfrrename_w.mysetup
...
[Registry]
 Root: HKCR; Subkey: "*\shell\researchrename1\command";   ValueType: string; ValueName: ""; ValueData: """{app}\{#MyAppExeName}"" ""%1"""
